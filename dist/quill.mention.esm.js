...
function (_Embed) {
  ...
  _createClass(MentionBlot, null, [{
    ...
    value: function setDataValues(element, data) {
      var domNode = element;
      domNode.classList.add("mention_".concat(data.id));
      return domNode;
    }
  }, {
    key: "value",
    value: function value(domNode) {
      var allValues = MentionBlot.getAllValues();
      var classes = domNode.getAttribute('class').split(' ');
      var mentionCls = classes.find(function (c) {
        return c.startsWith('mention_');
      });
      var value = mentionCls ? mentionCls.replace('mention_', '') : '';
      return allValues.find(function (e1) {
        return e1.id === value;
      }) || {
        id: value,
        value: value
...
MentionBlot.getAllValues = function () {
  return [];
};
